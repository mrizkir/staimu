...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $records=[
            ...
            'AKADEMIK-PERKULIAHAN-UJIAN-MUNAQASAH_BROWSE',
            'AKADEMIK-PERKULIAHAN-UJIAN-MUNAQASAH_DESTROY',
            'AKADEMIK-PERKULIAHAN-UJIAN-MUNAQASAH_STORE',
            'AKADEMIK-PERKULIAHAN-UJIAN-MUNAQASAH_SHOW',
            'AKADEMIK-PERKULIAHAN-UJIAN-MUNAQASAH_UPDATE',
