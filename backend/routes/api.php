...
$router->group(['prefix'=>'v3','middleware'=>'auth:api'], function () use ($router)
{
    ...
    $router->delete('/akademik/perkuliahan/pembagiankelas/deletepeserta/{id}',['middleware'=>['role:superadmin|akademik|programstudi'],'uses'=>'Akademik\PembagianKelasController@destroypengampu','as'=>'pembagiankelas.destroypeserta']);
