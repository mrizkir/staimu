...
class ReportAkademikTranskripKurikulumModel extends ReportModel
{   
  ...
  public function printtoexcel1()  
  {
		...
		$this->spreadsheet->getProperties()->setTitle("Report Rekap Transkrip Kurikulum");
		$this->spreadsheet->getProperties()->setSubject("Report Rekap Transkrip Kurikulum");

		$sheet = $this->spreadsheet->getActiveSheet();        
		$sheet->setTitle ('REKAP TRANSKRIP');
		...
		$sheet->setCellValue("A$row","LAPORAN REKAPITULASI TRANSKRIP KURIKULUM PROGRAM STUDI $nama_prodi");
		...
		return $this->excel("/report_transkrip_kurikulum_$generate_date.xlsx");
  }      
}