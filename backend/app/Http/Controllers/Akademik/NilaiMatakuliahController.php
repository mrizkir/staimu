    ...
    public function pesertakelas (Request $request,$id)
    {
        ...
        else
        {
            $peserta=PembagianKelasPesertaModel::select(\DB::raw('
                                        ...
                                        COALESCE(pe3_nilai_matakuliah.nilai_absen,0) AS nilai_absen,
                                        COALESCE(pe3_nilai_matakuliah.nilai_tugas_individu,0) AS nilai_tugas_individu,
                                        COALESCE(pe3_nilai_matakuliah.nilai_tugas_kelompok,0) AS nilai_tugas_kelompok,
                                        COALESCE(pe3_nilai_matakuliah.nilai_quiz,0) AS nilai_quiz,
