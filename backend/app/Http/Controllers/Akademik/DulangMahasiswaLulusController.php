...
class DulangMahasiswaLulusController extends Controller 
{
	/**
	 * daftar mahasiswa
	 */
	...
	{
		$this->hasPermissionTo('AKADEMIK-DULANG-LULUS_BROWSE');
  ...
  public function store(Request $request)
  {
	...
	{ 
		$this->hasPermissionTo('AKADEMIK-DULANG-LULUS_DESTROY');
		...
		else
		{
			\App\Models\System\ActivityLog::log($request,[
				...
				'message' => 'Menghapus daftar ulang mahasiswa lulus dengan id ('.$dulang->id.') berhasil'
			]);             
