...
class KemahasiswaanStatusKeluarController  extends Controller 
{
  /**
  ...
  */
  public function index(Request $request)
  {
    ...
    $data = RegisterMahasiswaModel::select(\DB::raw('                
            ...
            ->where('pe3_register_mahasiswa.k_status', 'K')            
    ...
    return Response()->json([
      ...
      'message' => 'Fetch data daftar mahasiswa yang keluar berhasil.'
    ], 200); 
  }
}