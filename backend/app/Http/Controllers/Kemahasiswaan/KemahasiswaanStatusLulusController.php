...
class KemahasiswaanStatusLulusController  extends Controller 
{
  /**
  ...
  */
  public function index(Request $request)
  {
    ...
    $data = RegisterMahasiswaModel::select(\DB::raw('                
            ...
            ->where('pe3_register_mahasiswa.k_status','L')            
    ...
    return Response()->json([
      ...
      'message'=>'Fetch data daftar mahasiswa yang lulus berhasil.'
    ], 200); 
  }
}