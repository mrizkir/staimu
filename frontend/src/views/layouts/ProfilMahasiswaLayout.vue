<template>
  <div>
    ...
    >
      ...
      <v-list expand>
        <v-list-item
          :to="{ path: '/kemahasiswaan/profil/' + user_id }"
          link
          :class="
            this.$store.getters['uiadmin/getTheme'](
        ...
        <v-list-item
          link
          :to="{ path: '/kemahasiswaan/profil/biodata/' + user_id }"
          :active-class="
            this.$store.getters['uiadmin/getTheme'](
        ...
        <v-list-item
          :to="{ path: '/kemahasiswaan/profil/aktivitaskuliah/' + user_id }"
          link					
          :active-class="
            this.$store.getters['uiadmin/getTheme'](
              'V-LIST-ITEM-ACTIVE-CSS-CLASS'
