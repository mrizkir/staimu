  ...
  <div>
    ...
    >
      ...
      <v-list expand>
        ...
        <v-list-item
          link
          v-if="CAN_ACCESS('DMASTER-PERSYARATAN-PMB_BROWSE')"
          to="/dmaster/persyaratanpmb"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-list-item
          link
          v-if="CAN_ACCESS('DMASTER-KELAS_BROWSE')"
          to="/dmaster/kelas"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-list-item
          link
          v-if="
            CAN_ACCESS('DMASTER-FAKULTAS_BROWSE') && isBentukPT('universitas')
          "
          to="/dmaster/fakultas"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-list-item
          link
          v-if="CAN_ACCESS('DMASTER-PRODI_BROWSE')"
          to="/dmaster/programstudi"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-list-item
          ...
          to="/dmaster/persyaratanujianmunaqasah"
        >
          <v-list-item-icon class="mr-2">
            <v-icon>mdi-format-list-checks</v-icon>
          </v-list-item-icon>
