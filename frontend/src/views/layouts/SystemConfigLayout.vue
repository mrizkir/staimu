	...
	<div>
		...
		>
			...
			<v-list expand>
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SYSTEM-SETTING-IDENTITAS-DIRI')"
					to="/system-setting/identitasdiri"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SYSTEM-SETTING-VARIABLES')"
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SYSTEM-SETTING-IDENTITAS-DIRI')"
					to="/system-setting/headerlaporan"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SYSTEM-SETTING-VARIABLES')"
					to="/system-setting/blog-infokampus"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('PLUGINS-H2H-ZOOMAPI_BROWSE')"
					to="/system-setting/zoom"
				>
					<v-list-item-icon class="mr-2">
