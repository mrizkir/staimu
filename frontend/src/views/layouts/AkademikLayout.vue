            ...
            <v-list expand>
                ...
                <v-list-group group="/akademik/perkuliahan/krs" active-class="yellow" no-action v-if="CAN_ACCESS('AKADEMIK-PERKULIAHAN-KRS_BROWSE')" color="green">
					...
					<div>
                        ...
                        <v-list-item link v-if="CAN_ACCESS('AKADEMIK-PERKULIAHAN-VERIFIKASI-KRS_STORE')" :to="{path:'/akademik/perkuliahan/krs/verifikasi'}">
                            <v-list-item-icon class="mr-2">
                                <v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
                            </v-list-item-icon>
                            <v-list-item-content>
                ...
                <v-list-group group="/akademik/nilai/matakuliah" active-class="yellow" no-action v-if="CAN_ACCESS('AKADEMIK-NILAI-MATAKULIAH_BROWSE') && (dashboard=='puslahta' || dashboard=='dosen')" color="green">
                    <template v-slot:activator>
                        <v-list-item-icon class="mr-2">
                            <v-icon>mdi-format-columns</v-icon>
                        </v-list-item-icon>
					...
					<div>
						<v-list-item link v-if="CAN_ACCESS('AKADEMIK-NILAI-MATAKULIAH_STORE') && dashboard=='dosen'" :active-class="this.$store.getters['uiadmin/getTheme']('V-LIST-ITEM-ACTIVE-CSS-CLASS')" to="/akademik/nilai/matakuliah/isiperdosen" color="white">
                            <v-list-item-icon class="mr-2">
                                <v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
                            </v-list-item-icon>
                            <v-list-item-content>
                ...
                <v-list-item link v-if="CAN_ACCESS('AKADEMIK-NILAI-KONVERSI_BROWSE')" :active-class="this.$store.getters['uiadmin/getTheme']('V-LIST-ITEM-ACTIVE-CSS-CLASS')" :to="{path:'/akademik/nilai/konversi'}">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
