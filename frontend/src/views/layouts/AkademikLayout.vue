<template>
	<div>
		...
		>
			<strong>Hak Akses Sebagai :</strong>
			{{ ROLE }}
		</v-system-bar>
		<v-app-bar app>
			<v-app-bar-nav-icon
		...
		>
			...
			<v-list expand>
				...
				<v-subheader v-if="CAN_ACCESS('SYSTEM-USERS-DOSEN-WALI_BROWSE')">
					PERWALIAN
				</v-subheader>
				<v-list-item
					link
				...
				>
					...
					<div>
						...
						<v-list-item
							link
							v-if="CAN_ACCESS('AKADEMIK-PERKULIAHAN-VERIFIKASI-KRS_STORE')"
							:to="{ path: '/akademik/perkuliahan/krs/verifikasi' }"
						>
							<v-list-item-icon class="mr-2">
								<v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
							</v-list-item-icon>
				...
				<v-list-group
					...
					active-class="yellow"
					no-action
					v-if="CAN_ACCESS('AKADEMIK-PERKULIAHAN-PKRS_BROWSE')"
					color="green"
				>
					<template v-slot:activator>
						<v-list-item-icon class="mr-2">
						...
						<v-list-item-content>
							<v-list-item-title>PKRS</v-list-item-title>
						</v-list-item-content>
					</template>
					<div>
						<v-list-item
							...
							"
							to="/akademik/perkuliahan/pkrs/daftar"
							color="white"
						>
							<v-list-item-icon class="mr-2">
								<v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
						...
						<v-list-item
							link
							v-if="CAN_ACCESS('AKADEMIK-PERKULIAHAN-PKRS_SHOW')"
							:active-class="
								this.$store.getters['uiadmin/getTheme'](
									'V-LIST-ITEM-ACTIVE-CSS-CLASS'
								)
						...
						<v-list-item
							...
							disabled
							:to="{
								path: '/akademik/perkuliahan/pkrs/' + paramid + '/tambahmatkul',
							}"
						>
							<v-list-item-icon class="mr-2">
								<v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
				...
				<v-list-group
					...
					v-if="
						CAN_ACCESS('AKADEMIK-NILAI-MATAKULIAH_BROWSE') &&
							(dashboard == 'puslahta' || dashboard == 'dosen')
					"
					color="green"
				>
					<template v-slot:activator>
					...
					<div>
						<v-list-item
							...
							"
							to="/akademik/nilai/matakuliah/isiperdosen"
							color="white"
						>
							<v-list-item-icon class="mr-2">
								<v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('AKADEMIK-NILAI-KONVERSI_BROWSE')"
					:active-class="
						this.$store.getters['uiadmin/getTheme'](
							'V-LIST-ITEM-ACTIVE-CSS-CLASS'
						)
					"
					:to="{ path: '/akademik/nilai/konversi' }"
				>
					<v-list-item-icon class="mr-2">
						<v-icon>mdi-arrow-right-bold-hexagon-outline</v-icon>
					</v-list-item-icon>
		...
		<v-footer app padless fixed>
			<v-card class="flex" color="yellow darken-2" flat tile>
				...
				<v-card-text class="py-2 black--text text-center">
					...
					dikembangkan oleh TIM IT IAI Miftahul 'Ulum Tanjungpinang
