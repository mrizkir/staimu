	...
	<div>
		...
		>
			...
			<v-list expand>
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB-SOAL_BROWSE')"
					to="/spmb/soalpmb"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB_BROWSE')"
					to="/spmb/pendaftaranbaru"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB-FORMULIR-PENDAFTARAN_BROWSE')"
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB-PERSYARATAN_BROWSE')"
					to="/spmb/persyaratan"
				>
					<v-list-item-icon class="mr-2">
						<v-icon>mdi-file-document-edit-outline</v-icon>
				...
				<v-list-item
					link
					v-if="
						CAN_ACCESS('SPMB-PMB-JADWAL-UJIAN_BROWSE') &&
							dashboard != 'mahasiswabaru' &&
							dashboard != 'mahasiswa'
					"
					to="/spmb/jadwalujianpmb"
				>
					<v-list-item-icon class="mr-2">
				...
				<v-list-item
					link
					v-if="
						CAN_ACCESS('SPMB-PMB-NILAI-UJIAN_BROWSE') &&
							dashboard != 'mahasiswabaru' &&
							dashboard != 'mahasiswa'
					"
					to="/spmb/nilaiujian"
				...
				<v-list-item
					link
					v-if="
						CAN_ACCESS('SPMB-PMB-LAPORAN-FAKULTAS_BROWSE') &&
							isBentukPT('universitas')
					"
					to="/spmb/laporanfakultas"
				>
					<v-list-item-icon class="mr-2">
						<v-icon>mdi-file-document-edit-outline</v-icon>
					</v-list-item-icon>
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB-LAPORAN-PRODI_BROWSE')"
					to="/spmb/laporanprodi"
				>
					<v-list-item-icon class="mr-2">
						<v-icon>mdi-file-document-edit-outline</v-icon>
					</v-list-item-icon>
				...
				<v-list-item
					link
					v-if="CAN_ACCESS('SPMB-PMB-LAPORAN-KELULUSAN_BROWSE')"
					to="/spmb/laporankelulusan"
				>
					<v-list-item-icon class="mr-2">
						<v-icon>mdi-file-document-edit-outline</v-icon>
					</v-list-item-icon>
