								...
								<v-dialog v-model="dialogfrm" max-width="500px" persistent>
									<v-form ref="frmdata" v-model="form_valid" lazy-validation>
										<v-card>
											<v-card-title>
												<span class="headline">
													TAMBAH TRANSAKSI T.A {{ tahun_akademik }}
												</span>
											</v-card-title>
											<v-card-text>
												<v-text-field
												...
												<v-alert type="warning">
													...
													September {{ tahun_akademik }} s.d Februari
													{{ tahun_akademik + 1 }} = GANJIL<br />
													Maret {{ tahun_akademik + 1 }} s.d JULI
													{{ tahun_akademik + 1 }} = GENAP<br />
													AGUSTUS {{ tahun_akademik + 1 }} = PENDEK (bila
													ada)<br />
												</v-alert>
												<v-select
