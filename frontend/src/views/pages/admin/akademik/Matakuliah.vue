		...
		<v-container fluid> 
          ...
          >
                        ...
                        >
												...
												<v-switch
													v-model="formdata.syarat_pplpkl"
													label="SYARAT PPL / PKL"
												>
												</v-switch>
												<v-switch
											...
											<v-row no-gutters>
												...
												<v-col xs="12" sm="6" md="6">
													<v-card flat>
														...
														<v-card-subtitle>
															{{ formdata.syarat_pplpkl == 1 ? "YA" : "TIDAK"}} /
          ...
          this.expanded = [item];
						...
						await this.$ajax.post("/akademik/matakuliah/" + this.formdata.id,
							{
								...
								syarat_pplpkl: this.formdata.syarat_pplpkl,
			...
			salinmatkul() {
				if (this.$refs.frmdialogcopymatkul.validate()) {
					...
					this.$ajax
						.post(
							"/akademik/matakuliah/salinmatkul/" + this.tahun_akademik,
							{
