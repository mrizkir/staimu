<template>
  <AkademikLayout>
    ...
    <dialog-printout-akademik pid="KHS" title="KHS" ref="dialogprint"></dialog-printout-akademik>
  </AkademikLayout>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async printpdf(item) {
        ...
        await this.$ajax
          .get("/akademik/nilai/khs/printpdf/" + item.id, {
      ...
      printtoexcel: async function() {
        ...
        await this.$ajax
          .post(
            "/akademik/nilai/khs/printtoexcel1",
            {
              prodi_id: this.prodi_id,
              ta: this.tahun_akademik,
              semester_akademik: this.semester_akademik,
          ...
          .then(({ data }) => {
            ...
            link.href = url;
            link.setAttribute("download", "rekap_khs_" + Date.now() + ".xlsx");
    ...
    components: {
      ...
      ModuleHeader,
      Filter6,
      "dialog-printout-akademik": DialogPrintoutAkademik,
    },
  };
</script>
