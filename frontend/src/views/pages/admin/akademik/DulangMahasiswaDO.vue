	...
	<AkademikLayout>
		<ModuleHeader>
			...
			<template v-slot:name>
				DAFTAR ULANG MAHASISWA DROPOUT / PUTUS
			</template>
			...
			<template v-slot:desc>
				<v-alert color="cyan" border="left" colored-border type="info">
					Halaman untuk melihat daftar mahasiswa yang dropout / putus.
				</v-alert>
			</template>
		</ModuleHeader>
