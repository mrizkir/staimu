	...
	export default {
		...
		data: () => ({
			...
			rule_jam_masuk: [
				...
				value => /^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/.test(value) || "Format jam masuk mengajar hh:mm, misalnya 15:00"
			],
			rule_jam_keluar: [
				value => !!value || "Mohon diisi jam keluar mengajar!!!",
				value => /^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/.test(value) || "Format jam keluar mengajar hh:mm, misalnya 15:30"
			],
			rule_ruang_kelas: [
