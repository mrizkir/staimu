	...
	<AkademikLayout>
		<ModuleHeader>
			...
			<template v-slot:name>
				DAFTAR ULANG MAHASISWA NON-AKTIF
			</template>
			...
			<template v-slot:desc>
				<v-alert color="cyan" border="left" colored-border type="info">
					Halaman untuk melihat daftar mahasiswa yang non-aktif.
				</v-alert>
			</template>
		</ModuleHeader>
				...
				this.$root.$confirm
					...
					.then(confirm => {
						if (confirm) {
							...
							this.$ajax
								.post(
									"/akademik/dulang/mhsnonaktif/" + item.id,
									{
										_method: "DELETE",
									},
									{
